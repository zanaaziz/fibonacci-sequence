...
# [THIS WILL MAKE OR BREAK YOUR FUNCTION] the lru_cache package caches(saves) each n calculation so that the function doesn't have to recalculate n on every sequence and ultimately slow down to a fatal point
